...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    community: [
      ...
      { name: 'LinkedIn', href: 'https://www.linkedin.com/in/krishnanath-s-24055a227', external: true },
      { name: 'Instagram', href: 'https://www.instagram.com/krishnanath_s_guruji/', external: true },
    ],
  };
