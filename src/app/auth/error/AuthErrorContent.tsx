  ...
  useEffect(() => {
    ...
    switch (error) {
      ...
      case 'EmailCreateAccount':
        setErrorMessage('Unable to create account with that email. Please try a different email.');
        break;
      case 'Callback':
        setErrorMessage('An error occurred during authentication. Please try again.');
        break;
      case 'OAuthCallback':
        setErrorMessage('An error occurred during OAuth authentication. Please try again.');
        break;
      case 'OAuthSignin':
        setErrorMessage('An error occurred during OAuth sign in. Please try again.');
        break;
      case 'EmailSignin':
        setErrorMessage('An error occurred sending the email. Please try again.');
        break;
      case 'Configuration':
        setErrorMessage('There is a problem with the server configuration.');
        break;
      default:
        setErrorMessage(error || 'An unknown error occurred during authentication.');
        break;
    }
  }, [error]);
