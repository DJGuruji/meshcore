        ...
        <div className="prose prose-invert max-w-none rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/60 backdrop-blur-2xl">
          <section className="mb-8">
            ...
            <p className="text-slate-300 mb-4">
              Welcome to AnyTimeRequest (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). These Terms and Conditions (&quot;Terms&quot;) govern your access to and use of our website and services. By accessing or using our website, you agree to be bound by these Terms and our Privacy Policy.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 mb-4">
              AnyTimeRequest provides a platform for developers and teams to create, test, and manage APIs. Our services include but are not limited to:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 mb-4">
              All content, features, and functionality on our website are owned by AnyTimeRequest or its licensors and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>
            <p className="text-slate-300">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 mb-4">
              To the maximum extent permitted by law, AnyTimeRequest shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or business opportunities.
            </p>
            <p className="text-slate-300">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300">
              You agree to indemnify, defend, and hold harmless AnyTimeRequest and its affiliates from and against any claims, liabilities, damages, losses, and expenses arising out of or in any way connected with your access to or use of our services.
            </p>
          </section>
